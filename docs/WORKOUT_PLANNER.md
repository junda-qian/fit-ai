...
## Intensity-Rep Relationship

### Average Reps at Different Intensities

This table shows how many reps people can perform on average for bench presses, leg presses, and other exercises at different intensity levels (%1RM).

| Intensity (%1RM) | Bench Press | Leg Press | Other exercises |
| --- | --- | --- | --- |
| 95% | 3 | 7 | 3 |
| 90% | 4 | 9 | 5 |
| 85% | 6 | 11 | 7 |
...
*There's a separate table for bench presses and leg presses, because these exercises have been found to have significantly different intensity-load relationships than other exercises.
