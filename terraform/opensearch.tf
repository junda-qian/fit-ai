...
# TEMPORARILY DISABLED: OpenSearch costs ~$700+/month even when empty
# Only needed for chatbot RAG feature, not required for AI agent development
# Uncomment when chatbot feature is needed
